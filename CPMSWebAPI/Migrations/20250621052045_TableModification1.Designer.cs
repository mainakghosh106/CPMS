...
namespace CPMSWebAPI.Migrations
{
    ...
    [Migration("20250621052045_TableModification1")]
    partial class TableModification1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CPMSWebAPI.Models.Users", b =>
                {
                    b.HasOne("CPMSWebAPI.Models.UserRole", "Role")
                        .WithOne("User")
                        .HasForeignKey("CPMSWebAPI.Models.Users", "RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
